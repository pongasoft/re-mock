...
#pragma once
#ifndef __PongasoftCommon_re_mock_mock_dst_h__
#define __PongasoftCommon_re_mock_mock_dst_h__
...
#endif //__PongasoftCommon_re_mock_mock_dst_h__
